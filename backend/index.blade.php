...
@section('title', 'Ecommerce Sebangku || ADMIN DASHBOARD')
        ...
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              ...
              <div class="row no-gutters align-items-center">
                <div class="col-auto">
                  <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">{{\App\Models\Product::countTotalProducts()}}
                  </div>
                </div>
    ...
    <div class="col-xl-3 col-md-6 mb-4">
      <div class="card border-left-success shadow h-100 py-2">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Products Active</div>
        ...
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              ...
              <div class="h5 mb-0 font-weight-bold text-gray-800">{{ \App\Models\Users::countTotalUsers() }}</div>

              <!-- Divider -->
              <hr class="my-2">

              <!-- Total Users Active -->
              <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Total Users Active</div>
              <div class="h5 mb-0 font-weight-bold text-gray-800">
                {{ \App\Models\Users::where('status', 'active')->count() }}
              </div>
            </div>
            <div class="col-auto">
